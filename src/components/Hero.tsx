      ...
      <div className="container mx-auto z-10 text-center">
        <div className="inline-block mb-6 opacity-0 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <span className="px-4 py-1.5 rounded-full bg-ocean/10 text-ocean text-sm font-medium border border-ocean/20">
            Free AI Travel Planning Tool by AI Web Tools
          </span>
        </div>
        ...
        <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl mx-auto opacity-0 animate-fade-in" style={{ animationDelay: '0.6s' }}>
          Travel Agent GPT is a free AI tool that crafts personalized itineraries, finds the best deals, and handles every detail from flights to attractions—all while staying within your budget. Powered by AI Web Tools.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12 opacity-0 animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <a 
            ...
            aria-label="Start using Travel Agent GPT - Free AI Travel Planning Tool"
          >
            <Plane size={18} />
            Plan My Trip Now - Free
          </a>
          <a href="#how-it-works" className="btn-secondary text-center" aria-label="Learn how our free AI travel tool works">
            Learn How It Works
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto opacity-0 animate-fade-in" style={{ animationDelay: '1s' }}>
          <div className="card-glass p-5">
            ...
            <h3 className="text-lg font-medium mb-2">AI-Powered Itineraries</h3>
            <p className="text-white/70 text-sm">Custom travel plans generated by artificial intelligence, tailored to your preferences and interests</p>
          </div>
          ...
          <div className="card-glass p-5">
            ...
            <h3 className="text-lg font-medium mb-2">Smart Day Planning</h3>
            <p className="text-white/70 text-sm">AI-optimized daily schedules with activities, restaurants, and attractions for maximum efficiency</p>
          </div>
          ...
          <div className="card-glass p-5">
            ...
            <h3 className="text-lg font-medium mb-2">Best AI Deal Finder</h3>
            <p className="text-white/70 text-sm">Real-time AI search for the best prices on flights, hotels, and travel packages</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto mt-16 opacity-0 animate-fade-in" style={{ animationDelay: '1.2s' }}>
        <div className="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden card-glass p-2">
          <img 
            ...
            alt="Travel Agent GPT AI travel planning tool in action - Free AI Web Tools" 
